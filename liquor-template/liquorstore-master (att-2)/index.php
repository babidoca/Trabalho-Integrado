...
<body>
    <?php
        ...
        $produtoAparecer=  $_SESSION['produtoo'];
                        ...
                        if($administrador=="true"){
                         echo  "<li class='nav-item dropdown active'>
                            ...
                            <div class='dropdown-menu' aria-labelledby='dropdown04'>
                                ...
                                <button data-target='#ModalAtt' data-toggle='modal'data-toggle='modal' class='dropdown-item' >Atualizar</button>
                                <button data-target='#ModalRemove' data-toggle='modal'data-toggle='modal' class='dropdown-item' >Remover</button>
                                <button onclick='add()' class='dropdown-item' >Remover</button>
                                </div>";
                        }
                            ?>
            </div>
...
echo ("<div class='modal fade' id='ModalAtt' tabindex='-1' role='dialog' aria-labelledby='exampleModalCenterTitle' aria-hidden='true'>
<div class='modal-dialog modal-lg modal-dialog-centered' role='document'>
  <div class='modal-content rounded-0'>
    <div class='modal-body py-0'>
      ...
      <div class='d-flex main-content'>
        ...
        <div class='content-text p-4'>
          ...
          <div class='form-group'>
          <label for='name'>Campo de atualização</label>
          <input type='text' class='form-control' id='email' placeholder='Insira o campo'>
        </div>
