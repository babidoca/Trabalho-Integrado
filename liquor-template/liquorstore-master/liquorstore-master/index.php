            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown active">
                        ...
                        <li class="nav-item dropdown active">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Administrador</a>
                            <div class="dropdown-menu" aria-labelledby="dropdown04">
                                <a class="dropdown-item" >Adicionar</a>
                                <a class="dropdown-item" >Atualizar</a>
                                <a class="dropdown-item" >Remover</a>
                            </div>
                ...
                <div class="col-sm-12 col-md">
                    <div class="ftco-footer-widget mb-4 ml-md-4">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="profile.html"><span class="fa fa-chevron-right mr-2"></span>Minha conta</a></li>
                            <li><a href="registro.html"><span class="fa fa-chevron-right mr-2"></span>Registrar</a></li>
