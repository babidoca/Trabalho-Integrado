            ...
            <div class="row justify-content-center">
                <div class="col-xl-10 ftco-animate">
                    <form method="post" class="billing-form">
                        ...
                        <div class="w-100"></div>
                        <button href="#" type="submit " class="btn btn-primary py-3 px-4">Finalizar reserva</button>
                </div>
            </div>
            </form><!-- END -->
            ...
            <div class="row mt-5 pt-3 d-flex">
                <div class="col-md-6 d-flex">
                    <div class="cart-detail cart-total p-3 p-md-4">
                        <h3 class="billing-heading mb-4">Detalhes da reserva</h3>
                        <p class="d-flex" id="teste">
                            ...
                            <span><?php
                                    ...
                                    $endereco = "INSERT INTO mydb.endereco(rua, bairro,numero,complemento,cidade,pessoa_id) VALUES ('$rua','$bairro','$numero','$complemento','$cidade','$idd')";
                                    ...
                                    if ($enderecoo == true) {
                                        ...
                                        $id = "SELECT produto.id FROM produto WHERE produto.nome='$nomeProduto'";
                                        $resultado = mysqli_query($conn, $id);
                                        ...
                                        $dataReservaInicio = $agora->format('Y/m/d');
                                        ...
                                        $reservaTotal = "INSERT INTO mydb.reserva(dataReservaInicio, dataReservaFim,valorTotal,hora,descricao,cliente_id) VALUES ('$dataReservaInicio', '$dataReservaFim','$valorTotal','$hora','$descricao','$idd')";

                                        if ($conn->query($reservaTotal) === TRUE) {
                                            $last_id = $conn->insert_id;


                                            $item_reserva = "INSERT INTO mydb.item_reserva(precoPraticadoUnitario, quantidade, descricao, reserva_id, produto_id)
                                        VALUES ('$precoProduto','$quantidade','$descricao','$last_id','$idProduto')";

                                            if ($conn->query($item_reserva) == TRUE) {
                                                echo "$" . $valorTotal . ",00";
                                            }
                                        } else {
                                            echo "Error: " . $conn->error;
